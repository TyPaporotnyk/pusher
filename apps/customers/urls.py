...
urlpatterns = [
    ...
    path("groups/", views.CustomerGroupView.as_view({"get": "retrieve", "post": "create"}), name="customer-groups"),
    path(
        "keywords/", views.CustomerKeywordView.as_view({"get": "retrieve", "post": "create"}), name="customer-keywords"
    ),
    path(
        "categories/",
        views.CustomerCategoryView.as_view({"get": "retrieve", "post": "create"}),
        name="customer-categories",
    ),
    path(
        "blacklists/",
        views.CustomerBlackListView.as_view({"get": "retrieve", "post": "create"}),
